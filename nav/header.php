    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarScroll" style="font-size: 25px;">
        <ul class="navbar-nav ms-auto my-3 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link <?= ($this->page == 'About') ? 'active bg-gradient-primary' : '' ?>" href=" About.php?">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?= ($this->page == 'Contact') ? 'active bg-gradient-primary' : '' ?>" href="Contact.php?">Contact</a>
          </li>
          <li class="nav-item">
